...
import brand_logo from "../../assets/images/logo-desktop.png";
import hero_design_element from "../../assets/images/hero_image_desktop.jpg";
import hero_curve_bg from "../../assets/svg/top curve.svg";
import innovation_image from "../../assets/images/innovation@2x.jpg";
// technology images
...
// card images
import card_img_1 from "../../assets/svg/process.svg";
...
import heart from "../../assets/svg/love.svg";
      ...
      <main className="landing">
          ...
          <div className="container">
            ...
            <div>
              ...
              <motion.img
                ...
                whileInView="show"
                viewport={{ once: true }}
                src={hero_design_element}
                className="landing_hero_image"
                alt=""
              />
            </div>
          </div>
        ...
        <section className="landing_section_technology mg-t-32 pd-t-32">
          <div className="container">
            ...
            <motion.p
              ...
              initial="hidden"
              whileInView="show"
              className="landing_section_text ta-ctr"
            >
        ...
        <section className="landing_section_next">
          <div className="container">
            ...
            <div className="flx gp-12 aln-ctr flx-wrp mg-b-12">
              <motion.p
                variants={{
                  hidden: {
                    opacity: 0,
                ...
                whileInView="show"
                viewport={{ once: true }}
                className="landing_section_text_l"
              >
                Make Radical
              </motion.p>
              <motion.div
                ...
                whileInView="show"
                viewport={{ once: true }}
                className="landing_section_text_l_multicolor"
              >
                <div>
            ...
            <div className="flx gp-12 aln-ctr flx-wrp">
              <motion.p
                variants={{
                  hidden: {
                    opacity: 0,
        ...
        <section className="landing_section_cards ">
          <div className="container pd-t-32">
            ...
            <div className="landing_card_grid pd-t-32">{renderCardData()}</div>
          </div>
        </section>
          ...
          <div className="container">
            ...
            >
              ...
              <div className="landing_slider">
                ...
                <div className="landing_slider_slideshow flx aln-ctr jty-spb gp-4">
                  <button
        ...
        <section className="landing_section_awards">
          <div className="container">
            ...
            <motion.p
              ...
              className="landing_section_text landing_section_text_s ta-ctr"
            >
              We work with the Top innovators in the world and are recognized by
              Intel.
            </motion.p>
            <div className="landing_awards_grid">{renderAwardsData()}</div>
          </div>
        </section>
        <section className="landing_section_contact">
          <div className="container">
            <motion.h3
              variants={{
                hidden: {
            ...
            <motion.p
              ...
              className="landing_section_text landing_section_text_s ta-ctr"
            >
              Your next big innovation could be around the corner. Get in touch
              with us to explore more.
            </motion.p>
            <motion.div
              variants={{
                hidden: {
